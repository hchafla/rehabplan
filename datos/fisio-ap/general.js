window.FISIOAP_GENERAL = {
  ...
  "normativaDinamometria": {
    "steiber2016": {
      ...
      "guiaMedicionHTML": "<h4>Cómo realizar la medición</h4><p>Esta guía sigue el <strong>procedimiento de medición empleado en el German Socio-Economic Panel (SOEP)</strong>, registro poblacional alemán cuyos datos de fuerza de prensión fueron utilizados por Steiber para establecer los valores de referencia incluidos en este formulario.</p><p><strong>Preparación</strong></p><ul><li>Realiza la medición <strong>preferentemente de pie</strong>.</li><li>Ajusta el mango del dinamómetro al tamaño de la mano.</li><li>Coloca el <strong>brazo junto al tronco</strong>, sin elevarlo durante la prueba.</li><li>Mantén el <strong>codo aproximadamente a 90° de flexión</strong> y el <strong>antebrazo en posición neutra</strong>.</li><li>Mantén la <strong>muñeca en posición neutra</strong> y el dinamómetro aproximadamente en posición vertical.</li><li>Explica previamente al paciente cómo debe realizar la prueba y demuéstrala si es necesario.</li></ul><p><strong>Ejecución</strong></p><ul><li>Pide al paciente que <strong>apriete el dinamómetro con la máxima fuerza posible</strong>.</li><li>Evita que eleve o separe el brazo del cuerpo o que cambie la posición durante la contracción.</li><li>Realiza <strong>dos mediciones en cada mano</strong>, alternando entre derecha e izquierda.</li><li>Lee y registra el valor obtenido con la mayor precisión disponible. No redondees innecesariamente el resultado.</li><li>Si una medición se realiza de forma incorrecta, no la utilices y registra la incidencia en las observaciones.</li></ul><p><strong>Posición alternativa</strong></p><p>Si la medición no puede realizarse de pie, puede realizarse <strong>sentado</strong>, manteniendo la misma posición del miembro superior y apoyando el brazo cuando sea necesario para poder ejecutar correctamente la prueba.</p><div class=\"dinamometria-imagen-info-wrap\"><img src=\"datos/fisio-ap/img/dinamometro.webp\" alt=\"Dinamómetro Smedley\" class=\"dinamometria-imagen-info\"></div><p><strong>Para comparar resultados entre sesiones</strong></p><p>Utiliza, siempre que sea posible:</p><ul><li>el mismo dinamómetro;</li><li>la misma configuración del mango;</li><li>la misma posición;</li><li>el mismo número de intentos;</li><li>el mismo procedimiento de ejecución.</li></ul><p>La estandarización es especialmente importante cuando se pretende comparar la evolución de un paciente entre diferentes sesiones.</p><h4>Valores de referencia</h4><p>Los valores mostrados en este formulario proceden del estudio de <strong>Steiber (2016)</strong>, elaborado a partir de los datos del SOEP. En el SOEP se utilizó un <strong>Smedley S Dynamometer TTM Tokio de 100 kg</strong> y se realizaron dos mediciones de fuerza de prensión en cada mano.</p><p>Los valores de referencia están estratificados según:</p><ul><li>sexo;</li><li>edad;</li><li>talla.</li></ul><p>Se muestran como <strong>valores de referencia poblacionales</strong> y no constituyen por sí mismos un criterio diagnóstico individual. La comparación debe interpretarse teniendo en cuenta que pueden existir diferencias relacionadas con el instrumento y con el procedimiento de medición.</p><p class=\"dinamometria-cita\"><strong>Referencia:</strong><br>Steiber N. <em>Strong or Weak Handgrip? Normative Reference Values for the German Population across the Life Course Stratified by Sex, Age, and Body Height.</em> PLOS ONE. 2016;11(10):e0163917. DOI: 10.1371/journal.pone.0163917.</p>"
    }
  }
};
